        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YandexDiskPath = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AccessRule_FileOrFolder", "(\"FileId\" IS NOT NULL AND \"FolderId\" IS NULL) OR (\"FileId\" IS NULL AND \"FolderId\" IS NOT NULL)");
                    table.CheckConstraint("CK_AccessRule_UserOrGroup", "(\"UserId\" IS NOT NULL AND \"GroupId\" IS NULL) OR (\"UserId\" IS NULL AND \"GroupId\" IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_AccessRules_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessRules_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessRules_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessRules_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_CreatedById",
                table: "AccessRules",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_FileId_GroupId",
                table: "AccessRules",
                columns: new[] { "FileId", "GroupId" });

            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_FileId_UserId",
                table: "AccessRules",
                columns: new[] { "FileId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_FolderId_GroupId",
                table: "AccessRules",
                columns: new[] { "FolderId", "GroupId" });

            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_FolderId_UserId",
                table: "AccessRules",
